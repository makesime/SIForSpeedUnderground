...
namespace UnityStandardAssets.Vehicles.Car
{
	...
	public class CarController : MonoBehaviour
	{
		...
		private bool useNitro = false; // If the car nitro is on
...
//			}
		...
		public void UIManager()
		{
			...
			uiNitro.sizeDelta = new Vector2( uiNitro.sizeDelta.x, nitroFactor * 200);
		}
		...
		IEnumerator OnTriggerEnter(Collider other) 
		{
			...
			yield return new WaitForSeconds (5); // Throwing in a random generating for amount of time before it turns on again.
